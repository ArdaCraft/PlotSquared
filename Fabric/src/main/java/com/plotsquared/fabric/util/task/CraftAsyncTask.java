...
class CraftAsyncTask extends CraftTask {
    ...
    private final LinkedList<FabricWorker> workers = new LinkedList<>();
    private final Map<Integer, CraftTask> runners;

    CraftAsyncTask(final Map<Integer, CraftTask> runners, final FabricPlatform plugin, final Runnable task, final int id, final long delay) {
    ...
    public void run() {
        ...
        synchronized(workers) {
            ...
            workers.add(
                    new FabricWorker() {
                        ...
                        public FabricPlatform getOwner() {
        ...
        try {
            ...
            throw new RuntimeException(
                    String.format(
                            "FabricPlatform generated an exception while executing task %s",
                            getTaskId()),
                    thrown);
        } finally {
